    ...
    <section className="section btc-history" id="bitcoin-history" aria-labelledby="bitcoin-history-title">
      <div className="container">
        ...
        <p className="section-lede">
          ...
          line: an illustrative path through a {formatUsd(BTC_REFERENCE.priceUsd)} end-of-2026 low, then{" "}
          {formatUsd(BTC_FUTURE_SCENARIO.priceUsd)} in {BTC_FUTURE_SCENARIO.asOf} — the same fixed prices the calculator
          uses. Peaks, valleys, and that dashed extension are not a promise of where price goes next.
        </p>
        ...
        <p className="compliance-strip btc-history-disclaimer">
          ...
          are not a prediction of future returns. The dashed path through a {formatUsd(BTC_REFERENCE.priceUsd)}{" "}
          end-of-2026 low and {formatUsd(BTC_FUTURE_SCENARIO.priceUsd)} in {BTC_FUTURE_SCENARIO.asOf} is illustrative
          arithmetic only — the same fixed prices shown in the calculator, not a forecast. If a decline like a
          prior-cycle drawdown would leave you unable to make a mortgage or HELOC payment from ordinary income,
          borrowing against your home to buy Bitcoin is not appropriate for you. This chart does not feed the calculator
