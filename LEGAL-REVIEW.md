...
**Where:** site-wide positioning; `/legal/disclaimer`; FAQ "Are you a registered
investment adviser?"
...
|---|---|---|---|---|
| 2.1 | "Not a registered investment adviser / broker-dealer / mortgage broker / MLO / bank / lender / money transmitter" | Footer, `/legal/disclaimer`, `/book` | §IV.C | Confirm accurate and complete for every state served |
...
| 2.10 | "You could lose your home" / foreclosure risk | FAQ, `/legal/disclaimer` | §VII.E | Confirm phrasing meets applicable disclosure standards |
| 2.11 | Tax comment re: interest deductibility depending on use of proceeds | `/is-this-for-you`, FAQ | §55 tax discussion | Confirm accurate and adequately hedged; consider removing entirely |
| 2.12 | Terms of service | `/legal/terms` | — | **Drafted by non-counsel. Full review required.** |
| 2.13 | Privacy policy | `/legal/privacy` | — | **Drafted by non-counsel. Full review required.** CCPA/CPRA adequacy; update for any analytics or CRM added later |
...
- [ ] Counsel review and rewrite of `/legal/terms` and `/legal/privacy`
...
- [ ] Replace both `PLACEHOLDER` Calendly URLs in `src/config/site.ts`
